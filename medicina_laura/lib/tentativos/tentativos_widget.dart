...
import 'tentativos_model.dart';
export 'tentativos_model.dart';

class TentativosWidget extends StatefulWidget {
  const TentativosWidget({
    Key? key,
  ...
  @override
  _TentativosWidgetState createState() => _TentativosWidgetState();
}

class _TentativosWidgetState extends State<TentativosWidget> {
  late TentativosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TentativosModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MedcinaClasesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final tentativosMedcinaClasesRecord = snapshot.data!;
